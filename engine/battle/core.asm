...
.got_gender
	hlcoord 10, 1 ;  where the enemy's mons gender is printed
	ld [hl], a
	hlcoord 3, 1  ;  where the enemy's mons status is printed
	...
	hlcoord 7, 1 ; where the enemy mon's lvl is printed
	ld a, [wEnemyMonLevel]
	ld [wTempMonLevel], a
	call PrintLevel
